...
Through a combination of lectures, fieldwork and computer lab activities, this course will provide an introduction to bioacoustics. Enrolling to this course, you will learn about the properties of sound, mechanisms of sound signals production, propagation and reception, how to record acoustic signals and how to perform a spectrogram analysis. This is meant to prepare you to be a bioacoustician: a scientist able to design, execute and present a bioacoustics research. As a bioacoustician, you can work as professor, industrial researcher, wildlife consultant or a sound engineer. 


##Format

This course will be taught in person with 3 hours long meetings, twice a week for eight weeks (16 sessions). It will combine lectures, field work and computer lab activities, as students will be required to develop a research project.


##Pre-requisites

Prior knowledge on animal behavior is desirable but not required. Students must know the elements of scientific method to design their research projects. They also need high school physics' knowledge on waves.
...
In Bioacoustics 101, we will use both formative and summative assessments to receive and provide feedback to students. Both assessment strategies will cover theoretical and practical knowledge, as students must plan and execute a research, participate in group discussions, do fieldwork and complete exams.

###Formative assessments

* __Prior knowledge and learning styles:__ Students must complete an online quiz so the staff can establish a knowledge baseline and select the best media platform (e.g. videos, models, computer simulations) to give examples of the content given in each session.
* __Equipment operation:__ This will be a hands on experience so the students can put what they learned to the test. They will have the opportunity to see and manipulate several types of microphones, hydrophones, analog and digital recorders. They will be able to test different sampling configurations and correlate it with the recorded sound samples quality and characteristics. This assessment is important to make sure the students will be able to do the research project.
* __Bioacoustics jeopardy!:__ This will be a fun way to test the students' knowledge retention and assess which part of the content they are having trouble with. Students will be organized in groups and must answers questions about bioacoustics just like the popular TV game show "Jeopardy!".
* __Research pre-project discussion:__ This is a way to let the students to share their ideas and doubts about the research project. Groups will summarize their project plans to the class so they can receive suggestions and positive criticism from colleagues and the staff.
* __Sound spectrum analysis:__ This will be another hands on experience so the students can put what they learned to the test. They will have the opportunity to use the Raven Pro 1.4 sound analysis software. They will be able to test different software configurations and correlate it with the different spectrograms they produce. This assessment is important to make sure the students will be able to do the research project.

###Summative assessments

* __Mid term exam:__ This will be an exam with ten open questions about the content covered in weeks 1, 2 and 3. _This will represent 25% of the final grade and is due to week 3._
* __Peer reviewed article discussion:__ Students will be organized in groups and must present to the class three articles on bioacoustics. Some interesting topics are: recording and spectral analyses methods, census methods, behavior descriptions and literature reviews. Each group will have 10 minutes for presentation and an additional 5 minutes to answer questions about their articles. Students may start this assignment (article selection) in the first week. _This will represent 20% of the final grade and is due to week 5._
* __Research project:__ Students will be organized in groups and will have to develop a bioacoustics study. They will have to review the scientific literature, design an experiment, record acoustic signals, perform an spectrogram analysis and present their results to the class. Each group will have 20 minutes for presentation and an additional 10 minutes to answer questions about their studies. Students may start their project (bibliographic review) in the first week. _This will represent 30% of the final grade and is due to week 8._
* __Final exam:__ This will be an exam with ten open questions about the content covered in weeks 4, 5 and 6. _This will represent 25% of the final grade and is due to week 8._
